...
class PersonalInfo(forms.Form):
    full_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Asefa Nigus'}))
    dob = forms.CharField(widget=forms.DateInput(attrs={'placeholder': '22-07-1982'}))
    another_fullname = forms.CharField(widget=forms.TextInput(attrs={'placeholder': ''}))
